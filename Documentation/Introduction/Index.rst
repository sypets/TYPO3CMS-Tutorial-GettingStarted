...
.. tip:: Select the correct version
   ...
   of the menu to select a different version of this tutorial (see `Version Selector
...
the section :ref:`next-steps-editors` to get some pointers for further reading.
